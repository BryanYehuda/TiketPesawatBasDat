...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 15 Jan 2021 pada 15.18
...
hewan_tumbuhan = hewan_tumbuhan_pm ,
narkoba_sajam = narkoba_sajam_pm ,
uang_1000 = uang_1000_pm ,
rokok_25batang = rokok_25batang_pm ,
barang_dagangan = barang_dagangan_pm ,
miras = miras_pm
...
nama = nama_pm ,
tgl_lahir = tgl_lahir_pm ,
jenis_kelamin = jenis_kelamin_pm ,
umur = umur_pm ,
kewarganegaraan = kewarganegaraan_pm ,
nomor_ktp = nomor_ktp_pm ,
no_hp = no_hp_pm ,
alamat = alamat_pm ,
pekerjaan = pekerjaan_pm ,
suket_covid = suket_covid_pm
...
--
-- Stand-in struktur untuk tampilan `cekkursi`
-- (Lihat di bawah untuk tampilan aktual)
--
DROP VIEW IF EXISTS `cekkursi`;
CREATE TABLE IF NOT EXISTS `cekkursi` (
`id_pesawat` int(11)
,`Dipesan` decimal(22,0)
,`Belum` decimal(22,0)
);
...
CREATE TABLE IF NOT EXISTS `pelanggan` (
  ...
  `id_status_pelanggan` tinyint(4) NOT NULL,
  ...
  `suket_covid` varchar(50) DEFAULT NULL,
...
(2, 2, 1, 'Beye', '1975-10-06 08:45:26', '', 45, 'GER', 'khoder@example.net', '7286329336966', '668-442-6169x', 'Surabaya', 'Makelar', 'null'),
(3, 1, 1, 'Final Project yang asik', '2021-01-13 00:00:00', 'cewek', 69, 'GBR', 'AndriLoveJanda@example.org', '967273637', '312312144', 'DimanaHayo', 'BelumBekerja', 'main flow.PNG'),
...
(8, 2, 0, 'Prima Secondary Ramadhan', '2001-12-12 00:00:00', 'cowok', 61, 'USA', 'prima_s@example.org', '1703977286666', '087632196969', 'Panti Jompo', 'Pengamen Jalanan', 'kampung cyber.jpg'),
...
(66, 66, 1, 'coba', '2021-01-13 00:00:00', 'other', 69, 'IDN', 'andriandriandri@gmail.com', '69696969696969', '79797979797', 'askdjaskdjaskjasdkjaskdjasdkjaskdj', 'antah berantah', NULL);

--
-- Trigger `pelanggan`
--
DROP TRIGGER IF EXISTS `order_success`;
DELIMITER $$
CREATE TRIGGER `order_success` AFTER UPDATE ON `pelanggan` FOR EACH ROW INSERT INTO pesanan_pelanggan
(
    id_pelanggan,
    id_status_pelanggan,
    id_kelas_safety,
...
CREATE TABLE IF NOT EXISTS `pesanan_pelanggan` (
  `id_pelanggan` int(11) NOT NULL,
  `id_status_pelanggan` tinyint(4) NOT NULL,
  `id_kelas_safety` tinyint(4) NOT NULL,
  `nama` varchar(50) NOT NULL,
...
INSERT INTO `pesanan_pelanggan` (`id_pelanggan`, `id_status_pelanggan`, `id_kelas_safety`, `nama`, `tgl_lahir`, `jenis_kelamin`, `umur`, `kewarganegaraan`, `email`, `nomor_ktp`, `no_hp`, `alamat`, `pekerjaan`, `suket_covid`, `tgl_perubahan`) VALUES
(8, 3, 0, 'Prima Shaladen', '2021-01-20 00:00:00', 'cowok', 61, 'USA', 'prima_s@example.org', '1703977286666', '087632196969', 'Panti Jompo', 'Pengamen Jalanan', '1600191431599.jpg', '2021-01-15 22:11:03');
...
(3, 4, 2, '987654321', 'genteng, jawa timur', 1, 0, 1, 0, 1, 0),
...
(8, 'mbuh@gmail.com', 'mbuh', '$2y$10$jmybh4g2eOU/N5VeX4pfseOSXTshrvbk3Y3/PbHI07eJaPjITE1Oe'),
(3, 'prima@gmail.com', 'prima', '$2y$10$9swoOJS7y3qBVH6MdjysPeyjcjNjrT73AhhVC/x5/lcXgAUUzATNe'),
(4, 'rangga@gmail.com', 'rangga', '$2y$10$sxctTzdmuePOfl8CVLWm..0sPQMFA9AcEyNgauMx8.acDW29Bvlem'),
(5, 'dava@gmail.com', 'dava', '$2y$10$HKQRB78XAm5vwUR3e774GeZ212f11u.rQ0cVXbBI9ypQul.XS3UUm'),
(6, 'jauhar@gmail.com', 'jauhar', '$2y$10$BfVo3eo5ysLpd9/lwI6f3uq87zaBBMUlDTzcDVvoMPDsAv0XhDAiq'),
(7, 'halo@gmail.com', 'halo', '$2y$10$NNMUyCPXLai1WB4nMyhnFOLfz5YuV/CimeSCeFoB38NqtDq4Dqz2e'),
(10, 'rama@gmail.com', 'rama', '$2y$10$7ZDYdF7WBhJo3QsQjJqiKefRdOy/cMJK0zNBG1sPRssf70nnxc4RO');

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `viewfiturekelas`
-- (Lihat di bawah untuk tampilan aktual)
--
DROP VIEW IF EXISTS `viewfiturekelas`;
CREATE TABLE IF NOT EXISTS `viewfiturekelas` (
`id_tipe_kursi` int(11)
,`harga` int(11)
,`id_fitur` int(11)
,`kursi` varchar(100)
,`ukuran_tv` varchar(100)
,`kualitas_tv` varchar(100)
,`snack` varchar(100)
,`makanan` varchar(100)
,`free_flow` varchar(100)
,`tempat_tidur` varchar(100)
,`penjemputan_bagasi` varchar(100)
,`priority_checkin` varchar(100)
);

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `viewpemesanan`
-- (Lihat di bawah untuk tampilan aktual)
--
DROP VIEW IF EXISTS `viewpemesanan`;
CREATE TABLE IF NOT EXISTS `viewpemesanan` (
...
--
-- Stand-in struktur untuk tampilan `viewstatusdanlamapenerbangan`
-- (Lihat di bawah untuk tampilan aktual)
--
DROP VIEW IF EXISTS `viewstatusdanlamapenerbangan`;
CREATE TABLE IF NOT EXISTS `viewstatusdanlamapenerbangan` (
`NomorPenerbangan` int(11)
,`LamaPenerbangan` time
,`StatusPenerbangan` varchar(15)
);

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `viewstatuspenerbangan`
-- (Lihat di bawah untuk tampilan aktual)
--
DROP VIEW IF EXISTS `viewstatuspenerbangan`;
CREATE TABLE IF NOT EXISTS `viewstatuspenerbangan` (
`NomorPenerbangan` int(11)
,`LamaPenerbangan` time
,`waktu_berangkat` datetime
,`id_pesawat` int(11)
,`StatusPenerbangan` varchar(14)
);

-- --------------------------------------------------------

--
-- Struktur untuk view `cekkursi`
--
...
--
-- Struktur untuk view `viewfiturekelas`
--
...
--
-- Struktur untuk view `viewpemesanan`
--
...
--
-- Struktur untuk view `viewstatusdanlamapenerbangan`
--
...
--
-- Struktur untuk view `viewstatuspenerbangan`
--
