<?php
    ...
    if(isset($_POST['submit'])){
        ...
        // suket_covid
            ...
            if (isset($_POST['penanda']))
            {
              $id_status_pelanggan = $_POST['penanda'];
            }
            if (isset($_POST['kelas_safety']))
            {
              $id_kelas_safety = $_POST['kelas_safety'];
            }
            ...
            if(in_array($imageFileType,$allowedTypes)){
                if(move_uploaded_file($_FILES["suket_covid"]["tmp_name"],$target_file)){
                    ...
                    // `id_status_pelanggan` = '$id_status_pelanggan' ,
                    // `id_kelas_safety` = '$id_kelas_safety' , 
                    // `nama` = '$nama' ,
                    // `tgl_lahir` = '$tgl_lahir' ,
                    ...
                    // Manggil Stored Procedured di phpmyadmin
                    $sql = "CALL `order` (
                    '$id_status_pelanggan' ,
                    '$id_kelas_safety' ,
                    '$nama' ,
                    ...
                    if(mysqli_query($conn,$sql)){
                        ...
                        myAlert("Order Ticket Success :)");
                        // myAlert("Order Ticket Fail :(");
        ...
        <div class="section no-pad-bot">
          <div class="container">
            ...
            <div class="row center">
              <h5 class="header col s12 white-text">Silahkan Pesan Tiket Anda disini!</h5>
            </div>
            <br><br>
